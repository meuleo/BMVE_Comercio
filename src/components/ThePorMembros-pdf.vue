<template>
<div id="content0" class="m-0 p-0">
        <div class="pt-4 px-2 pe-lg-3">
            <div>
                <h5 v-if="anoSelecionado" hidden>Relatório por membro ano {{ anoSelecionado }} </h5>
            ...
            <div class="py-3">
              ...
              <div class="">
                <div>
                  <button class="btn btn-dark me-2" @click="voltar">
                    Voltar
                  </button>
            ...
            <div id="content-pdf">
              <div class="py-3">
                <h5>Relatório de Mordomia - {{ anoSelecionado }} </h5>
              </div>
              <div class="table-responsive">
                  <table class="table table-striped" v-for="(totalMembro, idMembro) in totalPorMembroFiltrado" :key="idMembro" v-if="resultados == 1">
                    ...
                    <div class="pt-2 ps-2" style="font-size: 11px;">
                      <strong>
                        Relatório de mordomia - {{ anoSelecionado }} 
                      </strong>
                    </div>
                  </table>
